...
const SignUpPage = () => {
  ...
  return (
    <>
      {/* <div className='flex min-h-full hidden'>
            ...
            {!signUp ? (
              <div className='mx-auto flex flex-col flex-1 justify-center space-y-6 max-w-md'>
                ...
                <svg
                  ...
                  <h2 className='mt-4 text-2xl xl:text-4xl font-bold tracking-tight text-title'>You're one of the lucky ones!</h2>
                  <p className='mt-2 text-xl text-body'>Welcome to the game, register with an email & username to get started</p>
                </div>
